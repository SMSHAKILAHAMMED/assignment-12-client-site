...
const Footer = () => {
    return (
        <footer className="container mx-auto py-6 mt-8 dark:bg-gray-100 bg-black text-white dark:text-gray-900">
            <div className="container px-6 mx-auto space-y-6 divide-y dark:divide-gray-600 md:space-y-12 divide-opacity-50">
                <div className="grid grid-cols-12">
                    <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start">
                            ...
                            <span className="text-4xl font-bold bg-gradient-to-r from-orange-700 via-blue-500 to-green-400 text-transparent bg-clip-text animate-gradient">
                                <span className="text-primary">Book<span className="text-success">-</span><span className="text-error">Library</span></span></span>
                        </a>
                    </div>
                    <div className="col-span-6 text-center md:text-left md:col-span-3">
                        ...
                        <ul>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">SM Books Library</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">Books Shop</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">Book Store</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">Privacy</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">Terms of Service</a>
                            </li>
                        </ul>
                    </div>
                    <div className="col-span-6 text-center md:text-left md:col-span-3">
                        ...
                        <ul>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">Novel Books</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">Fantasy Books</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">History Books</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">Drama Books</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">Story Books</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-600 -mt-10">Proprietor By : SM SHAKIL</div>
            <span className="flex items-center justify-center -mt-6">
                ...
                <span className="dark:text-gray-600">smshakil492361@gmail.com</span>
            </span>
            <h1 className="text-center"> © All rights Reserved Company 2024.</h1>
        </footer>
    );
};
