...
const Login = () => {
    ...
    return (
        <div className="">
            ...
            <div className="w-full ml-96 max-w-md mt-10 p-8 space-y-3 border-2 shadow-lg rounded-xl dark:bg-gray-50 dark:text-gray-800">
                ...
                <form onSubmit={handleLogin} noValidate="" action="" className="space-y-6">
                    ...
                    <button className="btn btn-circle bg-green-600 w-full p-3 text-center rounded-sm dark:text-gray-50 dark:bg-violet-600">Login</button>
                </form>
                ...
                <div className="flex justify-center border-2 p-2 rounded-lg space-x-4">
                    ...
                    <button onClick={handleGithubSignIn} aria-label="Log in with GitHub" className="btn btn-primary p-3 border-2 rounded-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
